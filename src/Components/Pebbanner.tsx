...
const slides = [
  
  {
    title: "Commercial",
    description:
      "We shape skylines with iconic, world-class projects across the country.",
    video: "/video.mp4",
  },
  {
    title: "Government",
  ...
  },
  {
    title: "Healthcare",
    description:
      "Consistently ranked among the nation s top healthcare contractors, we have been chosen by healthcare clients time after time for more than 50 years.",
    video: "/video.mp4",
  },
];
