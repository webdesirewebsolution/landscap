...
export default function PebCallP() {
  const brands = [
    { id: 1, img: "/client1.png", name: "FWS" },
    { id: 2, img:  "/client2.jpeg", name: "GMR" },
    { id: 3, img: "/client2.jpeg", name: "GAIL" },
    { id: 4, img:  "/client2.jpeg", name: "GE" },
    { id: 5, img:  "/client2.jpeg", name: "Gold Plus" },
    { id: 6, img: "/client2.jpeg", name: "Hankuk" },
    { id: 7, img:  "/client2.jpeg", name: "Hankuk" },
    { id: 8, img:  "/client2.jpeg", name: "Hankuk" },
    { id: 9, img:  "/client2.jpeg", name: "Hankuk" },
  ];
